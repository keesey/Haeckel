...
(function (Haeckel) {
    ...
    var AxisChart = (function () {
        ...
        AxisChart.prototype.render = function (svg) {
            ...
            var area = this.area.empty ? Haeckel.rec.createFromBoundingClientRect(svg) : this.area, axis = this.axis, lineStyle = Haeckel.ElementBuilder.style(this.lineStyle || LINE_STYLE), g = new Haeckel.ElementBuilder(svg.ownerDocument, Haeckel.SVG_NS, 'g'), style = JSON.stringify(this.lineStyle);
