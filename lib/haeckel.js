...
var Haeckel;
(function (Haeckel) {
    Haeckel.XML_SERIALIZER = new XMLSerializer;
})(Haeckel || (Haeckel = {}));
var Haeckel;
(function (Haeckel) {
    var ElementBuilder = (function () {
        ...
        ElementBuilder.prototype.attach = function (parent) {
        ...
        ElementBuilder.prototype.buildString = function () {
            return Haeckel.XML_SERIALIZER.serializeToString(this.element);
        };
...
(function (Haeckel) {
    ...
    var AxisChart = (function () {
        ...
        AxisChart.prototype.render = function (svg) {
            ...
            var area = this.area.empty ? Haeckel.rec.createFromBoundingClientRect(svg) : this.area, axis = this.axis, lineStyle = Haeckel.ElementBuilder.style(this.lineStyle || LINE_STYLE), g = new Haeckel.ElementBuilder(svg.ownerDocument, Haeckel.SVG_NS, 'g');
...
(function (Haeckel) {
    ...
    var AxisLabeler = (function () {
        ...
        AxisLabeler.prototype.render = function (svg) {
            ...
            var area = this.area.empty ? Haeckel.rec.createFromBoundingClientRect(svg) : this.area, axis = this.axis, style = Haeckel.ElementBuilder.style(this.style || STYLE), g = new Haeckel.ElementBuilder(svg.ownerDocument, Haeckel.SVG_NS, 'g');
            if (Haeckel.isAxis(axis) && !axis.range.empty && axis.step > 0 && isFinite(axis.step)) {
...
(function (Haeckel) {
    ...
    var GeoChart = (function () {
        ...
        GeoChart.prototype.render = function (svg) {
            var _this = this;
            ...
            }, g = new Haeckel.ElementBuilder(svg.ownerDocument, Haeckel.SVG_NS, 'g'), i;
...
(function (Haeckel) {
    ...
    var GeoPhyloChart = (function () {
        ...
        GeoPhyloChart.prototype.render = function (svg) {
            var _this = this;
            ...
            var self = this, matrix = this.occurrenceMatrix, solver = this.solver, mapWidth = this.mapArea.width, nomenclature = this.nomenclature, taxonToCoords = {}, g = new Haeckel.ElementBuilder(svg.ownerDocument, Haeckel.SVG_NS, 'g');
...
(function (Haeckel) {
    ...
    var OccurrencePlotChart = (function (_super) {
        ...
        OccurrencePlotChart.prototype.render = function (svg) {
            var _this = this;
            var g = new Haeckel.ElementBuilder(svg.ownerDocument, Haeckel.SVG_NS, 'g');
...
(function (Haeckel) {
    ...
    var PhyloChart = (function (_super) {
        ...
        PhyloChart.prototype.render = function (svg) {
            var _this = this;
...
(function (Haeckel) {
    ...
    var ProximityBarChart = (function () {
        ...
        ProximityBarChart.prototype.renderBar = function (builder, bar, index, barWidth) {
            ...
            var rect = builder.child(Haeckel.SVG_NS, 'rect').attrs(Haeckel.SVG_NS, {
        ...
        ProximityBarChart.prototype.render = function (svg) {
            var g = new Haeckel.ElementBuilder(svg.ownerDocument, Haeckel.SVG_NS, 'g'), bars = this.getBars(), n = bars.length;
            if (n !== 0) {
...
(function (Haeckel) {
    ...
    var RegionChart = (function (_super) {
        ...
        RegionChart.prototype.render = function (svg) {
            var g = new Haeckel.ElementBuilder(svg.ownerDocument, Haeckel.SVG_NS, 'g'), regions = this.getRegions();
                ...
                if (p > 0) {
                    ...
                    if (typeof this.labels === "function") {
                        ...
                        if (label) {
                            ...
                            var labelGroup = regionGroup.child(Haeckel.SVG_NS, 'g'), text = labelGroup.child(Haeckel.SVG_NS, 'text').attr(Haeckel.SVG_NS, 'x', point.x + 'px').attr(Haeckel.SVG_NS, 'y', point.y + 'px').text(label.label).attrs(Haeckel.SVG_NS, label.attrs), box = text.build().getBBox(), rpx = (Math.min(box.width, box.height) / 2) + 'px', textBox = labelGroup.child(Haeckel.SVG_NS, 'rect').attrs(Haeckel.SVG_NS, {
...
(function (Haeckel) {
    ...
    var StratChart = (function (_super) {
        ...
        StratChart.prototype.render = function (svg) {
            var _this = this;
            ...
            var g = new Haeckel.ElementBuilder(svg.ownerDocument, Haeckel.SVG_NS, 'g'), boundaryList = Haeckel.ext.list(boundaries.build()).sort(Haeckel.rng.compare);
...
(function (Haeckel) {
    var StratLabeler = (function () {
        ...
        StratLabeler.prototype.render = function (svg) {
            var _this = this;
            var g = new Haeckel.ElementBuilder(svg.ownerDocument, Haeckel.SVG_NS, 'g'), chart = this.chart, yRange = Haeckel.rng.create(chart.area.top, chart.area.bottom), x = chart.area.right - this.margin, type = chart.type;
