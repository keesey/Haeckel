...
(function (Haeckel) {
    var ElementBuilder = (function () {
        ...
        ElementBuilder.prototype.attrs = function (attrs) {
    ...
    var AxisChart = (function () {
        ...
        AxisChart.prototype.render = function (svg) {
            function vLine(x, top, bottom) {
                return g.child(Haeckel.SVG_NS, 'path').attr(Haeckel.SVG_NS, 'style', lineStyle).attr(Haeckel.SVG_NS, 'path', "M" + x + " " + top + "V " + bottom);
            }
    ...
    var AxisLabeler = (function () {
        ...
        AxisLabeler.prototype.render = function (svg) {
            function text(x, y, text) {
                return g.child(Haeckel.SVG_NS, 'text').attr(Haeckel.SVG_NS, 'x', String(x) + 'px').attr(Haeckel.SVG_NS, 'y', String(y) + 'px').text(text);
            }
    ...
    var GeoChart = (function () {
        ...
        GeoChart.prototype.render = function (svg) {
            ...
            function createLine(a, b, occurrence) {
                g.child(Haeckel.SVG_NS, 'path').attr(Haeckel.SVG_NS, 'd', 'M' + a.x + ' ' + a.y + 'L' + b.x + ' ' + b.y).attr(Haeckel.SVG_NS, 'stroke', color.hex).attr(Haeckel.SVG_NS, 'stroke-opacity', '1').attr(Haeckel.SVG_NS, 'stroke-width', minThickness + 'px');
            }

            function createPoint(p, occurrence) {
                g.child(Haeckel.SVG_NS, 'circle').attr(Haeckel.SVG_NS, 'cx', p.x + 'px').attr(Haeckel.SVG_NS, 'cy', p.y + 'px').attr(Haeckel.SVG_NS, 'r', minThickness + 'px').attr(Haeckel.SVG_NS, 'color', color.hex).attr(Haeckel.SVG_NS, 'stroke', color.hex).attr(Haeckel.SVG_NS, 'stroke-opacity', '1').attr(Haeckel.SVG_NS, 'stroke-width', minThickness + 'px');
            }
            ...
            function createPolygon(points, occurrence) {
                ...
                g.child(Haeckel.SVG_NS, 'path').attr(Haeckel.SVG_NS, 'd', pathBuilder.build()).attr(Haeckel.SVG_NS, 'fill', color.hex).attr(Haeckel.SVG_NS, 'fill-opacity', '1').attr(Haeckel.SVG_NS, 'stroke', color.hex).attr(Haeckel.SVG_NS, 'stroke-opacity', '1').attr(Haeckel.SVG_NS, 'stroke-width', minThickness + 'px');
            }
